...
require (
	...
	github.com/networkteam/construct v0.5.1
	// Bundled tool for automatic build and restart of server during development
	github.com/networkteam/refresh v1.13.0
...
require (
	...
	github.com/networkteam/go-immutable v0.1.4-0.20211222090629-91036a8e4d09 // indirect

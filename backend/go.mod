...
require (
	...
	github.com/hibiken/asynq/x v0.0.0-20251110080853-ff887e1f8997 // indirect
...
// gotestsum generates JUnit xml reports of tests in CI
tool gotest.tools/gotestsum

// refresh automatically builds and restart of server during development
tool github.com/networkteam/refresh

// gqlgen generates the GraphQL API server code
tool github.com/99designs/gqlgen

tool github.com/boumenot/gocover-cobertura

tool github.com/networkteam/construct/v2/cmd/construct

tool github.com/hibiken/asynqmon/cmd/asynqmon

tool github.com/matryer/moq

replace github.com/getsentry/sentry-go/slog v0.35.3 => github.com/networkteam/sentry-go/slog v0.0.0-20250924100655-bb19dfca137e
